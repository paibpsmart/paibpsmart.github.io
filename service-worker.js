const CACHE_NAME="paibp-smart-v109-final-icon-hardfix-r1";
const STATIC=[
  ...
  "./visual-v84.css?v=84","./visual-v85.css?v=85","./icon-depth-v85.css?v=109","./icon-guard-v84.css?v=109","./menu-icons-v108.css?v=109",
  "./assets/menu-icons-v108/student.svg?v=109","./assets/menu-icons-v108/islamic.svg?v=109","./assets/menu-icons-v108/game.svg?v=109","./assets/menu-icons-v108/library.svg?v=109","./assets/menu-icons-v108/article.svg?v=109","./assets/menu-icons-v108/school.svg?v=109","./assets/menu-icons-v108/mapel.svg?v=109","./assets/menu-icons-v108/teacher.svg?v=109",
  "./global-visual-v102.css?v=102","./portal-fastnav-v102.js?v=102","./class-access-v102.js?v=102","./ui-clean-v102.js?v=102","./icon-art-v85.js?v=109","./ui-final-v105.css?v=109","./ui-final-v105.js?v=109","./mapel-premium-v102.css?v=102","./mapel-card-icons-v102.js?v=102",
...
self.addEventListener("activate",event=>{event.waitUntil((async()=>{
  ...
  for(const client of clients){try{const u=new URL(client.url);if(u.origin===self.location.origin&&u.searchParams.get("ui")!=="109"){u.searchParams.set("ui","109");await client.navigate(u.href)}}catch{}}
})())});
...
const v=url.searchParams.get("v");if(v==="109"&&(request.destination==="script"||request.destination==="style"||request.destination==="image")){event.respondWith(networkFirst(request));return}if(v==="102"&&(request.destination==="script"||request.destination==="style")){event.respondWith(staleWhileRevalidate(request));return}if(request.destination==="image"||request.destination==="font"){event.respondWith(cacheFirst(request));return}event.respondWith(networkFirst(request))});