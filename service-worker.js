const CACHE_NAME="paibp-smart-v98-fast-static";
const STATIC=[
  "./logo-spensus.png",
  "./assets/icons/icon-192.png",
  "./visual-v86.css?v=86",
  "./icon-v86.css?v=86",
  "./icon-art-v86.js?v=98",
  "./visual-fix-v87.css?v=98",
  "./visual-v89.css?v=98",
  "./home-clean-v92.js?v=98",
  "./home-ticker-v94.css?v=98",
  "./home-ticker-v93.js?v=98",
  "./teacher-preview-fix-v87.js?v=98",
  "./owner-editor-v98.js?v=98",
  "./multimapel-admin-v89.css?v=98",
  "./multimapel-admin-v89.js?v=98",
  "./spensus-ai-v90.css?v=98",
  "./spensus-ai-shell-v90.js?v=98",
  "./news-editor-entry-v96.js?v=98",
  "./news-editor-v96.css?v=96",
  "./news-editor-v96.js?v=96"
];
...
self.addEventListener("fetch",event=>{const request=event.request;if(request.method!=="GET")return;const url=new URL(request.url);if(url.origin!==self.location.origin)return;if(request.mode==="navigate"||request.destination==="document"){event.respondWith(networkFirst(request));return;}if(["86","87","88","89","90","92","93","94","95","96","97","98"].includes(url.searchParams.get("v"))&&(request.destination==="script"||request.destination==="style")){event.respondWith(cacheFirst(request));return;}if(request.destination==="image"||request.destination==="font"){event.respondWith(cacheFirst(request));return;}event.respondWith(networkFirst(request));});