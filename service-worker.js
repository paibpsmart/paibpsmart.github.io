const CACHE_NAME="paibp-smart-v101-fast-static";
const STATIC=[
  "./logo-spensus.png",
  "./assets/icons/icon-192.png",
  "./visual-v86.css?v=86",
  "./icon-v86.css?v=86",
  "./icon-art-v86.js?v=101",
  "./visual-fix-v87.css?v=101",
  "./visual-v89.css?v=101",
  "./home-clean-v92.js?v=101",
  "./home-ticker-v94.css?v=101",
  ...
  "./multimapel-admin-v89.js?v=101",
  "./spensus-ai-v90.css?v=101",
  "./spensus-ai-shell-v90.js?v=101",
  "./news-editor-entry-v96.js?v=101",
  "./news-editor-v99.css?v=101",
  "./news-editor-v101.js?v=101"
];
...
self.addEventListener("fetch",event=>{const request=event.request;if(request.method!=="GET")return;const url=new URL(request.url);if(url.origin!==self.location.origin)return;if(request.mode==="navigate"||request.destination==="document"){event.respondWith(networkFirst(request));return;}if(["86","87","88","89","90","92","93","94","95","96","97","98","99","100","101"].includes(url.searchParams.get("v"))&&(request.destination==="script"||request.destination==="style")){event.respondWith(cacheFirst(request));return;}if(request.destination==="image"||request.destination==="font"){event.respondWith(cacheFirst(request));return;}event.respondWith(networkFirst(request));});