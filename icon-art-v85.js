(() => {
  ...
  if(page==="index.html"){
    ...
    addScript("home-news-v102.js","102");addScript("home-news-media-v111.js","118");addScript("home-share-v102.js","119");
  ...
  if("serviceWorker" in navigator&&location.protocol!=="file:"){
    const register=()=>navigator.serviceWorker.register("service-worker.js?v=119").then(r=>r.update()).catch(()=>null);
